...
<div class="max-w-2xl mx-auto">
    ...
    <div class="relative" x-data="patientSearch()">
        ...
        <div class="flex gap-2">
            ...
            <a href="<?php echo e(url('/patients/create')); ?>" class="bg-green-600 hover:bg-green-700 text-white px-6 py-4 rounded-lg font-medium shadow-sm flex items-center gap-2 whitespace-nowrap">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/charlz/web_app/bhcis-new/resources/views/patients/index.blade.php ENDPATH**/ ?>