...
<div class="max-w-4xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-gray-500">Admitting Patient: <span class="font-bold text-green-700"><?php echo e($patient->last_name); ?>, <?php echo e($patient->first_name); ?></span></p>
        </div>
        <a href="<?php echo e(route('patients.show', $patient->id)); ?>" class="text-gray-500 hover:text-gray-700">Cancel</a>
    </div>

    <form action="<?php echo e(route('consultations.store', $patient->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/charlz/web_app/bhcis-new/resources/views/consultations/create.blade.php ENDPATH**/ ?>