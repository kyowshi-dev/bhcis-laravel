    ...
    <div class="md:col-span-1 space-y-6">
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            <div class="text-center mb-4">
                ...
                <h2 class="text-xl font-bold mt-2"><?php echo e($patient->last_name); ?>, <?php echo e($patient->first_name); ?></h2>
                <p class="text-gray-500 text-sm">ID: <?php echo e(str_pad($patient->id, 6, '0', STR_PAD_LEFT)); ?></p>
            </div>
            ...
            <div class="space-y-3 text-sm">
                <div class="flex justify-between">
                    ...
                    <span class="font-medium"><?php echo e($patient->age); ?> y/o / <?php echo e($patient->sex); ?></span>
                </div>
                <div class="flex justify-between">
                    <span class="text-gray-500">Birthdate:</span>
                    <span class="font-medium"><?php echo e($patient->date_of_birth); ?></span>
                </div>
                <div class="flex justify-between">
                    <span class="text-gray-500">Blood Type:</span>
                    <span class="font-medium"><?php echo e($patient->blood_type ?? 'N/A'); ?></span>
                </div>
                <div class="flex justify-between">
                    <span class="text-gray-500">Zone:</span>
                    <span class="font-medium">Zone <?php echo e($patient->zone_id); ?></span>
                </div>
                <div class="flex justify-between">
                    <span class="text-gray-500">Civil Status:</span>
                    <span class="font-medium"><?php echo e($patient->civil_status); ?></span>
                </div>
            </div>
    ...
    <div class="md:col-span-2">
        <div class="flex justify-between items-center mb-4">
            ...
            <button class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded shadow-sm text-sm">
                <a href="<?php echo e(route('consultations.create', $patient->id)); ?>" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded shadow-sm text-sm">
    		+ New Consultation
		</a>
            </button>
        </div>
                ...
                <table class="w-full text-sm text-left">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3"><?php echo e(\Carbon\Carbon::parse($record->created_at)->format('M d, Y')); ?></td>
                            <td class="px-4 py-3 font-medium text-gray-800"><?php echo e($record->complaint_name ?? 'General Checkup'); ?></td>
                            <td class="px-4 py-3"><?php echo e($record->worker_name ?? 'Staff'); ?></td>
                            <td class="px-4 py-3">
                                <span class="px-2 py-1 rounded-full text-xs 
                                    <?php echo e($record->status == 'completed' ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'); ?>">
                                    <?php echo e(ucfirst($record->status)); ?>

                                </span>
                            </td>
                            <td class="px-4 py-3 text-right">
                                <a href="<?php echo e(route('consultations.show', $record->id)); ?>" class="text-green-600 hover:underline font-bold">View</a>
                            </td>
                        </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/charlz/web_app/bhcis-new/resources/views/patients/show.blade.php ENDPATH**/ ?>